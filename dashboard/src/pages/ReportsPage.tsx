  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 bg-brand-600/10 border border-brand-600/30 rounded-xl">
        <FileText className="w-4 h-4 text-brand-400 mt-0.5 shrink-0" />
        <div className="text-xs text-slate-300">
          <span className="font-semibold text-brand-400">Phase 4 Feature:</span>{' '}
          Report download (PDF export) is coming in Phase 4. Report generation is available now and results are queued.
        </div>
      </div>
