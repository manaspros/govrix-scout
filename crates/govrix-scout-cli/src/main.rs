//! Govrix Scout CLI — `govrix-scout-ctl` command-line tool.
//!
//! Provides commands for interacting with a running Govrix Scout proxy:
...
/// Govrix Scout control plane CLI
#[derive(Debug, Parser)]
#[command(
    name = "govrix-scout-ctl",
    version = env!("CARGO_PKG_VERSION"),
    about = "Govrix Scout control plane CLI — interact with a running proxy",
    long_about = None,
)]
struct Cli {
